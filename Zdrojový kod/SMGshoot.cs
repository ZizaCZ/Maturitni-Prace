...
public class SMGshoot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) && playerScript2.WeaponSlot.transform.GetChild(0).name == "SMG")
        {
            Instantiate(Bullet, firepoint.position, firepoint.rotation);

        }
        if (Input.GetKeyDown(KeyCode.P) && playerScript.WeaponSlot.transform.GetChild(0).name == "SMG")
        {
            Instantiate(Bullet, firepoint.position, firepoint.rotation);
